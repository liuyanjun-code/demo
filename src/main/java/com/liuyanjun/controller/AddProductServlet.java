...
public class AddProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (filePart != null){
            System.out.println("file name :" + ((Part) filePart).getName() + "size" + filePart.getSize() + "file type" + filePart.getContentType());
    ...
    private class Prodcut extends com.liuyanjun.model.Product {
    }
}
